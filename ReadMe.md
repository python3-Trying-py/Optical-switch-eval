...
### models
Models contains all the logic related components of the program. evaluation_model contains the opm and optical switch objects and is responsible for interacting with them. background_model contains the logic object responsible for handling backend operations not related to evaluation(e.g. managing lists of saved devices)
...
### Misc.
## main.py
This file initialize the viewer, models, and controller, creates the logger, and starts up the app.

## devices.csv
This csv file stores the list of saved devices.
